<template>
            ...
            <div class="auth-container rounded-2xl p-6 md:p-8" 
              ...
              <div class="text-center mb-6">
                ...
                <p class="text-white/60 text-sm mt-3">
                  Enter your username or e-mail and we'll help you reset it.
                </p>
              </div>
              ...
              <form @submit.prevent="handleReset" class="space-y-4">
                ...
                <div class="form-group">
                  <label for="email" class="block text-white/80 text-sm font-medium mb-1.5">
                    Username or E-mail <sup class="text-red-400">*</sup>
                  </label>
                  <input 
                    type="text" 
                    id="email"
  ...
  const handleReset = async () => {
    ...
    // Simulate success
    successMessage.value = 'Password reset instructions have been sent to your email address. Please check your inbox.'
